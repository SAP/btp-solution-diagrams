...
By using this the [linked](https://github.com/SAP/btp-solution-diagrams/guideline/docs/examples/drawio-config-all-in-one.json) "all-in-one" json you can copy and paste this in the configuration of draw.io desktop:
